...
internal enum AuthSurfaceDiagnosticCode
{
    ...
    RoutePatternTooLarge,
    RoutePolicyTooComplex,
    RoutePolicyTooDeep,
    MetadataLimit,
    UnprotectedEndpoint,
...
internal static class AuthSurfaceDiagnosticCodes
{
    ...
    internal static string GetValue(this AuthSurfaceDiagnosticCode code) =>
        code switch
        {
            ...
            AuthSurfaceDiagnosticCode.EndpointLimit => "endpoint-limit",
            ...
            AuthSurfaceDiagnosticCode.RoutePatternTooLarge => "route-pattern-too-large",
            AuthSurfaceDiagnosticCode.RoutePolicyTooComplex => "route-policy-too-complex",
            AuthSurfaceDiagnosticCode.RoutePolicyTooDeep => "route-policy-too-deep",
            AuthSurfaceDiagnosticCode.MetadataLimit => "metadata-limit",
